// <auto-generated />
// Generated from tools/CodeGen/Templates/State.scriban-cs
#nullable enable
...
public sealed unsafe partial class Lua52State : ILuaState<Lua52State>
{
    ...
    Lua52State? ILuaState<Lua52State>.From => from;
    ILuaState? ILuaState.From => from;

    Lua52State(lua_State* ptr, Lua52State? from, LuaReference reference)
    {
        this.ptr = ptr;
        this.from = from;
    ...
    public static Lua52State Create()
    {
        ...
        var state = new Lua52State(ptr, null, default);
        ptrToState[(nint)ptr] = state;
        return state;
    }

    static Lua52State GetOrCreate(lua_State* ptr, LuaReference reference)
    {
        ...
        {
            state = new Lua52State(ptr, null, reference);
            ptrToState[(nint)ptr] = state;
            return state;
        }
    }
    ...
    void CheckDisposed()
    {
        if (ptr == null)
        {
            throw new ObjectDisposedException(nameof(Lua52State));
        }
    }
    ...
    public Lua52State ToThread(int index)
    {
        CheckDisposed();
    ...
    public void XMove(Lua52State target, int count)
    {
        CheckDisposed();
    ...
    {
        CheckDisposed();
        return Lua52AsyncDriver.RunAsync(this, initialArgCount, cancellationToken);
    }

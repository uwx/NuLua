...
using static NuLua.Interop.LuaJit.NativeMethods;

namespace NuLua.Interop.LuaJit;

public sealed unsafe class LuaJitOperations : ILuaOperations
{
    public static readonly LuaJitOperations Default = new();
    ...
    public void lua_rotate(void* state, int index, int count) => throw new NotSupportedException("lua_rotate is not supported in LuaJIT.");
    ...
    public int lua_compare(void* state, int index1, int index2, int operation) => throw new NotSupportedException("lua_compare is not supported in LuaJIT.");
    ...
    public void lua_arith(void* state, int operation) => throw new NotSupportedException("lua_arith is not supported in LuaJIT.");
    public void lua_len(void* state, int index) => throw new NotSupportedException("lua_len is not supported in LuaJIT.");
    public nuint lua_stringtonumber(void* state, byte* value) => throw new NotSupportedException("lua_stringtonumber is not supported in LuaJIT.");
    ...
    public int lua_geti(void* state, int index, long key) => throw new NotSupportedException("lua_geti is not supported in LuaJIT.");
    ...
    public int lua_rawgetp(void* state, int index, void* pointer) => throw new NotSupportedException("lua_rawgetp is not supported in LuaJIT.");
    ...
    {
        if (userValueCount != 1) throw new NotSupportedException("lua_newuserdatauv with userValueCount != 1 is not supported in LuaJIT.");
    ...
    {
        if (userValueIndex != 1) throw new NotSupportedException("lua_getiuservalue with userValueIndex != 1 is not supported in LuaJIT.");
        NativeMethods.lua_getfenv((lua_State*)state, index);
        return NativeMethods.lua_type((lua_State*)state, -1);
    }
    ...
    public void lua_seti(void* state, int index, long key) => throw new NotSupportedException("lua_seti is not supported in LuaJIT.");
    ...
    public void lua_rawsetp(void* state, int index, void* pointer) => throw new NotSupportedException("lua_rawsetp is not supported in LuaJIT.");
    ...
    {
        if (userValueIndex != 1) throw new NotSupportedException("lua_setiuservalue with userValueIndex != 1 is not supported in LuaJIT.");
    ...
    {
        if (continuation != null) throw new NotSupportedException("lua_callk is not supported in LuaJIT.");
    ...
    {
        if (continuation != null) throw new NotSupportedException("lua_pcallk is not supported in LuaJIT.");
    ...
    public int lua_load(void* state, delegate* unmanaged[Cdecl]<void*, void*, nuint*, byte*> reader, void* data, byte* chunkName, byte* mode)
        => NativeMethods.lua_loadx((lua_State*)state, (delegate* unmanaged[Cdecl]<lua_State*, void*, nuint*, byte*>)reader, data, chunkName, mode);
    ...
    {
        if (continuation != null) throw new NotSupportedException("lua_yieldk is not supported in LuaJIT.");
    ...
    public int luaopen_coroutine(void* state) => throw new NotSupportedException("luaopen_coroutine is not supported in LuaJIT.");
    ...
    public int luaopen_utf8(void* state) => throw new NotSupportedException("luaopen_utf8 is not supported in LuaJIT.");
    public int luaopen_bit32(void* state) => throw new NotSupportedException("luaopen_bit32 is not supported in LuaJIT.");
    ...
    public void luaL_checkversion_(void* state, double version, nuint size) => throw new NotSupportedException("luaL_checkversion_ is not supported in LuaJIT.");
    ...
    public byte* luaL_tolstring(void* state, int index, nuint* length) => throw new NotSupportedException("luaL_tolstring is not supported in LuaJIT.");
    ...
    public long luaL_len(void* state, int index) => throw new NotSupportedException("luaL_len is not supported in LuaJIT.");
    ...
    public int luaL_getsubtable(void* state, int index, byte* fieldName) => throw new NotSupportedException("luaL_getsubtable is not supported in LuaJIT.");
    ...
    public void luaL_requiref(void* state, byte* moduleName, delegate* unmanaged[Cdecl]<void*, int> openFunction, int global) => throw new NotSupportedException("luaL_requiref is not supported in LuaJIT.");
    ...
    public byte* luaL_buffinitsize(void* state, void* buffer, nuint size) => throw new NotSupportedException("luaL_buffinitsize is not supported in LuaJIT.");
    ...
    public void luaL_pushresultsize(void* buffer, nuint size) => throw new NotSupportedException("luaL_pushresultsize is not supported in LuaJIT.");
}

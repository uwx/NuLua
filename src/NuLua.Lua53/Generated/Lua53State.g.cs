...
public sealed unsafe partial class Lua53State : ILuaState<Lua53State>
{
    ...
    static Lua53State GetMainState(lua_State* L)
    {
    ...
    public bool TryGetUserValue(int index, int userValueIndex, out LuaValueType type)
    {
        ...
        var result = NativeMethods.lua_getuservalue(ptr, index);
    ...
    public void NewFunction(LuaFunc<Lua53State> func, int upvalueCount)
    {
    ...
    {
        CheckDisposed();
        return Lua53AsyncDriver.RunAsync(this, initialArgCount, cancellationToken);
    }

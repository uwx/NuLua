...
using static NuLua.Interop.Lua53.NativeMethods;

namespace NuLua.Interop.Lua53;

public sealed unsafe class Lua53Operations : ILuaOperations
{
    public static readonly Lua53Operations Default = new();
    ...
    {
        if (userValueCount != 1) throw new NotSupportedException("lua_newuserdatauv with userValueCount != 1 is not supported in Lua 5.3.");
    ...
    public void lua_getfenv(void* state, int index) => throw new NotSupportedException("lua_getfenv is not supported in Lua 5.3.");
    public int lua_getuservalue(void* state, int index) => NativeMethods.lua_getuservalue((lua_State*)state, index);

    public int lua_getiuservalue(void* state, int index, int userValueIndex)
    {
        if (userValueIndex != 1) throw new NotSupportedException("lua_getiuservalue with userValueIndex != 1 is not supported in Lua 5.3.");
        return NativeMethods.lua_getuservalue((lua_State*)state, index);
    }
    ...
    public int lua_setfenv(void* state, int index) => throw new NotSupportedException("lua_setfenv is not supported in Lua 5.3.");
    ...
    {
        if (userValueIndex != 1) throw new NotSupportedException("lua_setiuservalue with userValueIndex != 1 is not supported in Lua 5.3.");
    ...
    public int lua_cpcall(void* state, delegate* unmanaged[Cdecl]<void*, int> function, void* userData) => throw new NotSupportedException("lua_cpcall is not supported in Lua 5.3.");
    ...
    public void luaL_openlib(void* state, byte* libraryName, void* registrations, int upvalueCount) => throw new NotSupportedException("luaL_openlib is not supported in Lua 5.3.");
    public void luaL_register(void* state, byte* libraryName, void* registrations) => throw new NotSupportedException("luaL_register is not supported in Lua 5.3.");
    ...
    public int luaL_typerror(void* state, int argument, byte* typeName) => throw new NotSupportedException("luaL_typerror is not supported in Lua 5.3.");
    ...
    public byte* luaL_findtable(void* state, int index, byte* fieldName, int sizeHint) => throw new NotSupportedException("luaL_findtable is not supported in Lua 5.3.");

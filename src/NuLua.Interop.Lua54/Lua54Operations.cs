...
using static NuLua.Interop.Lua54.NativeMethods;

namespace NuLua.Interop.Lua54;

public sealed unsafe class Lua54Operations : ILuaOperations
{
    public static readonly Lua54Operations Default = new();
    ...
    public void lua_getfenv(void* state, int index) => throw new NotSupportedException("lua_getfenv is not supported in Lua 5.4.");
    ...
    public int lua_setfenv(void* state, int index) => throw new NotSupportedException("lua_setfenv is not supported in Lua 5.4.");
    ...
    public int lua_cpcall(void* state, delegate* unmanaged[Cdecl]<void*, int> function, void* userData) => throw new NotSupportedException("lua_cpcall is not supported in Lua 5.4.");
    ...
    public int luaopen_bit32(void* state) => throw new NotSupportedException("luaopen_bit32 is not supported in Lua 5.4.");
    ...
    public void luaL_openlib(void* state, byte* libraryName, void* registrations, int upvalueCount) => throw new NotSupportedException("luaL_openlib is not supported in Lua 5.4.");
    public void luaL_register(void* state, byte* libraryName, void* registrations) => throw new NotSupportedException("luaL_register is not supported in Lua 5.4.");
    ...
    public byte* luaL_findtable(void* state, int index, byte* fieldName, int sizeHint) => throw new NotSupportedException("luaL_findtable is not supported in Lua 5.4.");

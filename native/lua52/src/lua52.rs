...
pub const LUA_ENV: &[u8; 5] = b"_ENV\0";
...
pub const LUA_VERSION_MINOR: &[u8; 2] = b"2\0";
pub const LUA_VERSION_NUM: u32 = 502;
pub const LUA_VERSION_RELEASE: &[u8; 2] = b"3\0";
pub const LUA_VERSION: &[u8; 8] = b"Lua 5.2\0";
pub const LUA_RELEASE: &[u8; 10] = b"Lua 5.2.3\0";
pub const LUA_COPYRIGHT: &[u8; 52] = b"Lua 5.2.3  Copyright (C) 1994-2013 Lua.org, PUC-Rio\0";
...
pub const LUA_OPDIV: u32 = 3;
pub const LUA_OPMOD: u32 = 4;
pub const LUA_OPPOW: u32 = 5;
pub const LUA_OPUNM: u32 = 6;
...
pub const LUA_GCSETMAJORINC: u32 = 8;
...
unsafe extern "C" {
    pub fn lua_getglobal(L: *mut lua_State, var: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lua_setglobal(L: *mut lua_State, var: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn lua_getctx(L: *mut lua_State, ctx: *mut ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn lua_pcallk(
        L: *mut lua_State,
...
unsafe extern "C" {
    pub fn luaL_checkunsigned(L: *mut lua_State, numArg: ::std::os::raw::c_int) -> lua_Unsigned;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn luaL_len(L: *mut lua_State, idx: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn luaL_gsub(
        L: *mut lua_State,
...
pub struct luaL_Buffer {
    ...
    pub n: usize,
    pub L: *mut lua_State,
    pub initb: [::std::os::raw::c_char; 1024usize],
}
unsafe extern "C" {

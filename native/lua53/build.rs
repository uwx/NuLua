...
const FLAVOR: &str = "lua53";
const CSHARP_NAMESPACE: &str = "NuLua.Interop.Lua53";
const CSHARP_CLASS: &str = "NativeMethods";
const CSHARP_PROJECT: &str = "NuLua.Interop.Lua53";
...
fn generate_csharp_bindings<T: AsRef<Path>>(bindings_rs: T, out_cs: &Path) {
    ...
    csbindgen::Builder::default()
        ...
        .rust_file_header("use crate::lua53::*;")
        ...
        .generate_to_file("src/lua53_ffi.rs", out_cs.to_str().unwrap())

...
pub const LUA_LJDIR: &[u8; 28] = b"/usr/local/share/luajit-2.1\0";
pub const LUA_JPATH: &[u8; 35] = b";/usr/local/share/luajit-2.1/?.lua\0";
...
pub const LUA_PATH_CONFIG: &[u8; 11] = b"/\n;\n?\n!\n-\n\0";
...
pub const LUA_BITLIBNAME: &[u8; 4] = b"bit\0";
pub const LUA_JITLIBNAME: &[u8; 4] = b"jit\0";
pub const LUA_FFILIBNAME: &[u8; 4] = b"ffi\0";
...
unsafe extern "C" {
    pub fn luaopen_string_buffer(L: *mut lua_State) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
